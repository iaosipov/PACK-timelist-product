...
| TL.M.001 | Демо на живой встрече | M | Главный метод продажи | draft |
| TL.M.002 | Discovery-продажа | M | Выяснение задачи заказчика | draft |
| TL.M.003 | Закрытие возражений | M | Работа с типовыми сомнениями | draft |
| TL.M.004 | Создание стенограммы | M | Захват и расшифровка встречи | draft |
| TL.M.005 | Выгрузка в Bitrix24 | M | Импорт поручений из протокола | draft |
| TL.M.006 | Пилот 3 недели | M | Ограниченное внедрение | draft |
| TL.M.007 | Обучение культуры записи | M | Обучение пользователей | draft |
| TL.M.008 | Сбор сценариев через чат | M | Выявление сценариев у клиента | draft |
| TL.M.009 | Позиционирование статьи | M | Структура лендо-статьи | draft |
| TL.WP.001 | Расшифровка | WP | Стенограмма встречи | draft |
| TL.WP.002 | Автопротокол | WP | Структурированный документ | draft |
| TL.WP.003 | Поручения в Bitrix24 | WP | Задачи из протокола | draft |
| TL.WP.004 | Коммерческое предложение | WP | Прайс и тарифы | draft |
| TL.WP.005 | Памятка по регламенту | WP | Инструкция для сотрудников | draft |
| TL.WP.006 | Демо-доступ | WP | Доступ для самостоятельной проверки | draft |
| TL.WP.007 | Лендо-статья | WP | Продающая статья про таймбота | draft |
| TL.WP.008 | Отчёт по MAX-чатам | WP | Сводка задач из чатов | draft |
| TL.FM.001 | Неверная идентификация спикеров | FM | Ошибка распределения реплик | draft |
| TL.FM.002 | Непредсказуемый захват задач | FM | Автопротокол нестабилен | draft |
| TL.FM.003 | Дублирование систем | FM | MAX и Bitrix24 конкурируют | draft |
| TL.FM.004 | Перегруз сущностями | FM | Слишком много нового в пилоте | draft |
| TL.FM.005 | Передача данных в зарубежный сервис | FM | Нарушение 152-ФЗ | draft |
| TL.FM.006 | Продвижение не тому ЛПР | FM | Неправильный акцент в позиционировании | draft |
| TL.FM.007 | Конкуренция встроенных стенограмм | FM | Клиент не видит разницы | draft |
